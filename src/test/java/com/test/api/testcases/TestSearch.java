...
public class TestSearch extends Base {
  ...
  public void user(String keyword) {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/search/users")).param("q", keyword).log().all().headers("Authorization", token.visitor())
  ...
  public void video(String keyword) {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/search/videos")).param("q", keyword).log().all().headers("Authorization", token.visitor())
        .log().all().when().get().then().statusCode(200).log().all();
  ...
  public void videoNotFound() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/search/videos")).param("q", "epfhweguehferhbcdhfbsdjhfb").log().all().headers("Authorization", token.visitor())
