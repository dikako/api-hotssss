...
public class TestCompetition extends Base {
  ...
  public void competitionNow() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/now-competition")).headers("Authorization", token.visitor()).log().all().when().get().then().statusCode(200).log().all();
    }
  ...
  public void competitionSoon() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/soon-competition")).headers("Authorization", token.visitor()).log().all().when().get().then().statusCode(200).log().all();
    }
    ...
    public void competitionExpired() {
      ...
      rs.baseUri(baseUrl.urlUgcVote("/v1/competition/expired-competition")).headers("Authorization", token.visitor()).log().all().when().get().then().statusCode(200).log().all();
      }
  }  