...
public class TestLike extends Base {
  ...
  public void like() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/likes")).contentType(ContentType.JSON)
        .headers("Authorization", token.login("dikakoko04@gmail.com", "dikakoko", "1234", "android")).body(like).log()
  ...
  public void likeAlready() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/likes")).contentType(ContentType.JSON)
        .headers("Authorization", token.login("dikakoko04@gmail.com", "dikakoko", "1234", "android")).body(like).log()
        .all().then().statusCode(422).log().all();
  ...
  public void likeWithoutToken() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/likes")).contentType(ContentType.JSON)
        .headers("", "").body(like).log()
        .all().then().statusCode(401).log().all();
  ...
  public void likeWithTokenVisitor() {
    ...
    rs.baseUri(baseUrl.urlUgcVote("/v1/competition/likes")).contentType(ContentType.JSON)
        .headers("Authorization", token.visitor()).body(like).log()
        .all().then().statusCode(401).log().all();
